...
import os
import pandas as pd
from german_to_english_phoneme_mapping import phoneme_mapping

# mapping to phoible symbols
german_to_phoible = phoneme_mapping
...
def main(input_path):
    ...
    output_path = os.path.join(input_dir, f"{input_name}_final.csv")
